class Solution:
    def groupAnagrams(self, strs: list[str]) -> list[list[str]]:
        ...
        for word in strs:
            ...
            testWord = "".join(sorted(tempList))
            if testWord in wordDict:
                wordDict[testWord].append(word)
            else:
                wordDict[testWord] = [word]
...
#Original passing solution run at ~2877ms. The solution above passes at 87ms.
